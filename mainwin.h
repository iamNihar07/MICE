...
class Mainwin : public Gtk::Window {
    ...
    protected:
        ...
        void on_create_manager_click();               // Create a manager
        ...
        void on_byID_click();                          // Shows order by order ID for servers and customers
    private:
        ...
        int select_manager();                          // Select a manager index
